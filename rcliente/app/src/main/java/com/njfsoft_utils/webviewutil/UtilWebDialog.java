...
public class UtilWebDialog extends Dialog {
    ...
    static final FrameLayout.LayoutParams MAINFILL = new FrameLayout.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT);
...
currSwapStr = "noQvalue";
    ...
    public String getCurrSwapStr() {
        return currSwapStr;
    }
  
    public void setCurrSwapStr(String theCurrSwapStr) {
        currSwapStr = theCurrSwapStr;
    }

    public void setPopPage(String theUrl, String theHtml) {
        String fullUrl = "";
        if ((theUrl.startsWith("java")) || (theUrl.startsWith("http"))) {
            fullUrl = theUrl;
        } else {
