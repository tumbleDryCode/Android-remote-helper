...
public class AutoBot {
	...
	public void handleMessage(String event){
      ...
      System.out.println("handleMessage: " + event);	
      /* */
		try{
			...
			switch(eventcode){
				...
				default: System.out.println("ELSE:" + event);typer(event); break;
	...
	public void specialKey(int key_code){
		int key;
		      System.out.println("specialKey: " + key_code);	
		switch(key_code){
	...
	public void keyBoardPress(int key){
		try{
			System.out.println("keyBoardPress: " + key);
			robot.keyPress(key);
			robot.keyRelease(key);
		}catch(Exception e){
      System.out.println("keyBoardPress.error: " + e);	
		}
	}
	
	public void keyBoardPress(int key, int key2){
		try{
 			System.out.println("keyBoardPress: " + key + " : " + key2);
